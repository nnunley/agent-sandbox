...
- [x] Task-0 (be3e6c0 + review-fix bf1522b; two-stage PAR APPROVED; suite 468 green)  [x] T1a (35dfe91/2ab2d19/9fbf282; two-stage PAR APPROVED) [x] T1b (3356489/09116ee; two-stage PAR APPROVED; honest cluster-residual AC-2) [x] T1c (5791df2 rework 948d1af; two-stage PAR APPROVED; single shared substrate, hard assertions) [~] T2a [ ] T2b [ ] T2c  [ ] T3a [ ] T3b/d [ ] T3c  [ ] T4  [ ] T5  [ ] T6
