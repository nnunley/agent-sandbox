...
| SCENARIO-0117 | Host-signed laneq RPC accepted | integration | iteration | TBD | STORY-0080 |
| SCENARIO-0118 | Forged / expired / wrong-audience grant rejected | integration | iteration | TBD | STORY-0081 |
| SCENARIO-0119 | log-only mode allows and logs an invalid grant (safe rollout) | integration | iteration | TBD | STORY-0081 |
| SCENARIO-0120 | Grant key rotation via kid | integration | iteration | TBD | STORY-0079 |
