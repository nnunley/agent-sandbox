...
| JOURNEY-0002 | Live steering: high-priority directive preempts current work | e2e | sentinel | AUTOMATED (ITER-0008): `cd modules/incus-dispatcher && go test . -run TestJourney0002_LiveSteering` | STORY-0073, STORY-0012 |
...
| SCENARIO-0122 | Run captures artifact_refs/log_refs across artifact types | integration | iteration | AUTOMATED:ITER-0008: `cd modules/incus-dispatcher && go test . -run TestScenario0122_RunArtifactCapture` | STORY-0015 |
