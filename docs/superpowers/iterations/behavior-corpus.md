...
| SCENARIO-0121 | Policy-driven dispatch produces a Run with worker_kind/policy_id | integration | iteration | PLANNED (ITER-0008): `cd modules/incus-dispatcher && go test ./... -run TestScenario0121_PolicyDrivenDispatch` | STORY-0011, STORY-0035 |
...
| SCENARIO-0123 | Versioned policy: dispatch v1 → revise → dispatch v2, version recorded | integration | iteration | PLANNED (ITER-0008): `cd modules/incus-dispatcher && go test ./... -run TestScenario0123_VersionedPolicy` | STORY-0016 |
| SCENARIO-0124 | Mac stateless client: author → disconnect → reconnect → review without replay | e2e | iteration | PLANNED (ITER-0008): `cd modules/incus-dispatcher && go test . -run TestScenario0124_MacStatelessClient` | STORY-0006 |
